  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#09090b] text-zinc-100 linear-grid">
      ...
      <aside className="relative z-20 flex flex-col items-center py-4 flex-shrink-0 w-16 bg-[#0c0c0e] border-r border-zinc-800/80">
        ...
        >
          <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-zinc-900 border border-zinc-700/80 text-zinc-100 shadow-sm font-bold font-mono text-xs group-hover:border-zinc-500 transition-colors">
            EU
          </div>
        </Link>
