  ...
  if (topics.length === 0) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-center max-w-lg mx-auto">
        ...
        <h2 className="font-heading text-xl font-normal text-white mb-2">No study modules loaded</h2>
      ...
      <div className="w-full flex flex-col items-center">
        {isGenerating ? (
          <div className="w-full py-24 text-center flex flex-col items-center">
            ...
            <div className="font-heading text-lg font-normal text-white">
          ...
          <div className="w-full max-w-md p-10 rounded-2xl bg-[#14161e] border border-white/10 text-center flex flex-col items-center shadow-md">
            <div className="w-10 h-10 rounded-xl bg-zinc-900 border border-white/10 flex items-center justify-center text-emerald-400 mb-3">
              <Sparkles size={18} />
            </div>
            <h3 className="font-heading text-lg font-normal text-white mb-1.5">
              Ready to generate cards
            </h3>
            <p className="text-xs text-zinc-400 mb-6 leading-relaxed">
              Create an active recall set for <strong className="text-zinc-200">{activeTopic?.title}</strong>.
            </p>
            {generateError && (
          ...
          <motion.div
            ...
            className="w-full max-w-lg p-10 rounded-2xl bg-[#14161e] border border-white/10 text-center flex flex-col items-center shadow-2xl"
          >
            <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-zinc-400 font-semibold mb-6">
              Session Complete
            </span>
              ...
              {isFlipped ? (
                <div className="grid grid-cols-2 gap-3.5 w-full max-w-md">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border border-amber-500/30 transition-all font-mono text-xs font-medium cursor-pointer shadow-xs"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 transition-all font-mono text-xs font-medium cursor-pointer shadow-xs"
                  >
                    <Check size={14} />
                    <span>Mastered</span>
                ...
                <div className="flex items-center justify-between w-full max-w-md px-2 text-xs text-zinc-300 font-mono">
                  ...
                  <button
                    onClick={handleFlip}
                    className="px-4 py-1.5 rounded-lg bg-zinc-900 border border-white/10 text-white hover:bg-zinc-800 transition-colors cursor-pointer shadow-xs font-mono text-xs"
                  >
                    Reveal Answer
                  </button>
